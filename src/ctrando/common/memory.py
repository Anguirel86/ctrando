...
class Flags(enum.Enum):
    ...
    DENADORO_MTS_SPEED_TAB = FlagData(0x7F0064, 0x40)
    # 0x7F006A
    ...
    # 0x7F0070
    MOUNTAINS_RE_NICE_MAGIC_TAB = FlagData(0x7F0070, 0x01)
    OBTAINED_KEEPERS_DOME_MAGIC_TAB = FlagData(0x7F0070, 0x02)
    ...
    DEATH_PEAK_POWER_TAB = FlagData(0x7F007C, 0x08)
    ...
    MAGUS_CASTLE_DUNGEONS_MAGIC_TAB = FlagData(0x7F00D5, 0x02)
    TRANN_DOME_SEALED_MAGIC_TAB = FlagData(0x7F00D5, 0x04)
    ARRIS_DOME_SEALED_POWER_TAB = FlagData(0x7F00D5, 0x04)
    BLACKBIRD_DUCTS_MAGIC_TAB = FlagData(0x7F00D5, 0x10)
    # 0x7F00D8
    ...
    DORINO_BROMIDE_MAGIC_TAB = FlagData(0x7F00F6, 0x02)
    KAJAR_MAGIC_LAB_SPEED_TAB = FlagData(0x7F00F6, 0x04)
    NU_SCRATCH_MAGIC_TAB = FlagData(0x7F00F6, 0x08)
    MANORIA_CONFINEMENT_POWER_TAB = FlagData(0x7F00F6, 0x10)
    # 0x7F00F7
    ...
    OBTAINED_GREEN_DREAM_ITEM = FlagData(0x7F0107, 0x80)
    # 0x7F0136
    HAS_MET_RX_XR = FlagData(0x7F0136, 0x01)
    OBTAINED_JOHNNY_RACE_POWER_TAB = FlagData(0x7F0136, 0x02)
    USING_BOOSTLESS_RACE = FlagData(0x7F0138, 0x80)
    # 0x7F0138
    ...
    SUN_KEEP_600_POWER_TAB = FlagData(0x7F014A, 0x02)
    GENO_DOME_LABS_MAGIC_TAB = FlagData(0x7F014A, 0x04)
    GENO_DOME_CORRIDOR_POWER_TAB = FlagData(0x7F014A, 0x08)
    LAST_VILLAGE_NU_SHOP_MAGIC_TAB = FlagData(0x7F014A, 0x10)
    TRUCE_INN_SEALED_1000_OBTAINED = FlagData(0x7F014A, 0x20)
    TRUCE_INN_SEALED_CHEST_CHARGED = FlagData(0x7F014A, 0x40)
    TRUCE_INN_SEALED_600_OBTAINED = FlagData(0x7F014A, 0x80)
    # 0x7F014B
    GENO_DOME_LABS_SPEED_TAB = FlagData(0x7F014B, 0x01)
    GENO_DOME_ATROPOS_MAGIC_TAB = FlagData(0x7F014B, 0x02)
    # 0x7F014E
    ...
    HECKRAN_SEALED_OBTAINED = FlagData(0x7F01A0, 0x04)
    # 0x7F01A1
    ...
    # 0x7F01A4
    SUNKEN_DESERT_POWER_TAB = FlagData(0x7F014A, 0x01)
    MEDINA_ELDER_MAGIC_TAB = FlagData(0x7F014A, 0x02)
    MEDINA_ELDER_SPEED_TAB = FlagData(0x7F014A, 0x04)
    ...
    OZZIES_FORT_GUILLOTINES_TAB = FlagData(0x7F01A4, 0x40)
    CYRUS_GRAVE_MAGIC_TAB = FlagData(0x7F01A4, 0x80)
    # 0x7F01A5
    BLACK_OMEN_1F_PANELS_BOTTOM = FlagData(0x7F01A5, 0x40)
    BLACK_OMEN_1F_PANELS_TOP = FlagData(0x7F01A5, 0x80)
    # 0x7F01A6
    NORTHERN_RUINS_ANTECHAMBER_SEALED_600_OBTAINED = FlagData(0x7F01A6, 0x01)
    NORTHERN_RUINS_BACK_LEFT_SEALED_600_OBTAINED = FlagData(0x7F01A6, 0x02)
    NORTHERN_RUINS_BACK_RIGHT_SEALED_600_OBTAINED = FlagData(0x7F01A6, 0x04)
    NORTHERN_RUINS_ANTECHAMBER_SEALED_CHEST_CHARGED = FlagData(0x7F01A6, 0x08)
    NORTHERN_RUINS_BACK_LEFT_SEALED_CHEST_CHARGED = FlagData(0x7F01A6, 0x10)
    NORTHERN_RUINS_BACK_RIGHT_SEALED_CHEST_CHARGED = FlagData(0x7F01A6, 0x20)
    # 0x7F01A8
    ...
    NORTHERN_RUINS_ANTECHAMBER_SEALED_1000_OBTAINED = FlagData(0x7F01A9, 0x20)
    NORTHERN_RUINS_BACK_LEFT_SEALED_1000_OBTAINED = FlagData(0x7F01A9, 0x40)
    NORTHERN_RUINS_BACK_RIGHT_SEALED_1000_OBTAINED = FlagData(0x7F01A9, 0x80)
    # 0x7F01AC
    ...
    NORTHERN_RUINS_ANTECHAMBER_CHEST_1000_OBTAINED = FlagData(0x7F01AC, 0x04)
    NORTHERN_RUINS_ANTECHAMBER_CHEST_600_OBTAINED = FlagData(0x7F01AC, 0x08)
    ...
    PORRE_MAYOR_SEALED_1_OBTAINED = FlagData(0x7F01D1, 0x40)
    PORRE_MAYOR_SEALED_2_OBTAINED = FlagData(0x7F01D1, 0x80)
    # 7F01D2
    PORRE_MAYOR_SEALED_1_CHARGED = FlagData(0x7F01D2, 0x01)
    PORRE_MAYOR_SEALED_2_CHARGED = FlagData(0x7F01D2, 0x02)
    ...
    GUARDIA_FOREST_SEALED_600_OBTAINED = FlagData(0x7F01D2, 0x80)
    # 7F01D3
    PORRE_MARKET_600_TAB = FlagData(0x7F01D3, 0x01)
    GIANTS_CLAW_ENTRANCE_POWER_TAB = FlagData(0x7F01D3, 0x02)
    OBTAINED_GUARDIA_FOREST_1000_TAB = FlagData(0x7F01D3, 0x04)
    OBTAINED_GUARDIA_FOREST_600_TAB = FlagData(0x7F01D3, 0x08)
    PORRE_ELDER_SEALED_1_OBTAINED = FlagData(0x7F01D3, 0x10)
    PORRE_ELDER_SEALED_2_OBTAINED = FlagData(0x7F01D3, 0x20)
    GIANTS_CLAW_TRAPS_POWER_TAB = FlagData(0x7F01D3, 0x40)
    GIANTS_CLAW_CAVERNS_POWER_TAB = FlagData(0x7F01D3, 0x80)
    # 7F01D9
    GUARDIA_CASTLE_SEALED_CHEST_CHARGED = FlagData(0x7F00D9, 0x01)
    GUARDIA_CASTLE_SEALED_600_OBTAINED = FlagData(0x7F00D9, 0x02)
    GUARDIA_CASTLE_SEALED_1000_OBTAINED = FlagData(0x7F00D9, 0x04)
    # 0x7F01F0 (0x7E1BA7)
