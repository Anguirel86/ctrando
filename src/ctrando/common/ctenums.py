...
class LocID(StrIntEnum):
    ...
    # JUNK_66 = 0x66
    NORTHERN_RUINS_ENTRANCE_600 = 0x66
    JUNK_67 = 0x67
    JUNK_68 = 0x68
    JUNK_69 = 0x69
    JUNK_6A = 0x6A
    ...
    OCEAN_PALACE_ELEVATOR_BATTLES = 0x1A0
...
class TreasureID(StrIntEnum):
    ...
    TRADING_POST_PETAL_FANG_BASE = auto()
    TRADING_POST_PETAL_FANG_UPGRADE = auto()
    TRADING_POST_PETAL_HORN_BASE = auto()
    TRADING_POST_PETAL_HORN_UPGRADE = auto()
    TRADING_POST_PETAL_FEATHER_BASE = auto()
    TRADING_POST_PETAL_FEATHER_UPGRADE = auto()
    TRADING_POST_FANG_HORN_BASE = auto()
    TRADING_POST_FANG_HORN_UPGRADE = auto()
    TRADING_POST_FANG_FEATHER_BASE = auto()
...
class EnemyID(StrIntEnum):
    ...
    #  = 0xD8
    LASER_GUARD = 0xD9
    LAVOS_TANK_LEFT_HEAD = 0xDA
    LAVOS_TANK_RIGHT_GRINDER = 0xDB
