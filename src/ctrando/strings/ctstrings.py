...
class Node:
    ...
    def __init__(self):
        self.held_substring: typing.Optional[bytearray] = None
        self.held_substring_index: typing.Optional[int] = None
        self.children = {}
...
class CTHuffmanTree:
    ...
    def compress(self, string: bytearray) -> CTString:
...
_default_huff_pickle = \
    files('ctrando.strings').joinpath('huffman_table.pickle')
...
class CTString(bytearray):
    ...
    keywords = [
        'null', 'itemdesc', 'unused 0x02', 'delay',
    ...
    huffman_table = _default_huff_table
...
def get_huffman_table(rom: bytearray) -> list[bytearray]:
    ...
    for i in range(128):
        ...
        start = int.from_bytes(rom[ptr:ptr+2], "little") + bank
